...
export NEXT_PUBLIC_V3_PORTAL="${NEXT_PUBLIC_V3_PORTAL:-false}"
echo "==> npm run build (NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL}, NEXT_PUBLIC_BROWSER_CALLING_ENABLED=${NEXT_PUBLIC_BROWSER_CALLING_ENABLED}, NEXT_PUBLIC_SOFTPHONE_V2_ENABLED=${NEXT_PUBLIC_SOFTPHONE_V2_ENABLED}, NEXT_PUBLIC_V3_PORTAL=${NEXT_PUBLIC_V3_PORTAL})"
npm run build
