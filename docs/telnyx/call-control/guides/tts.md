...
source_url: "https://developers.telnyx.com/docs/voice/programmable-voice/tts.md"
category: "call-control"
synced_at: "2026-06-25T18:43:02.634Z"
content_hash: "41e1e57234b0e38a501a161d8a88a633a452b73279f5f81d78b8bc7d9e77862e"
---
> ## Documentation Index
...
> Use text-to-speech on Telnyx Programmable Voice to speak prompts and dynamic content. Supports AWS Polly, Google, ElevenLabs, Azure, and Telnyx voices.
...
<iframe src="https://player.vimeo.com/video/1109308018" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen />
...
* **Coda** (recommended) — Rime's flagship model (May 2026). LLM backbone with dedicated speech engine, sub-100ms latency, 184 voices, and top-rated quality in human evaluations. Supports English, Spanish, French, Portuguese, German, and Japanese. Voices use the `Rime.Coda.<VoiceId>` format.
...
Check the [Available Voices](/docs/tts-stt/tts-available-voices) page for specific voice names.
