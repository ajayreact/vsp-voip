---
title: "Retrieve a messaging hosted number"
source_url: "https://developers.telnyx.com/api-reference/messaging/retrieve-a-messaging-hosted-number.md"
category: "messaging"
synced_at: "2026-06-25T18:43:34.748Z"
content_hash: "c36a0495d12f5eb664166ef5e92d6dcb2bf1a511e2273dc9b4d74fda63f1a1ec"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/messaging/hosted-numbers.yml get /messaging_hosted_numbers/{id}
openapi: 3.1.0
info:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.messagingHostedNumbers.retrieve('id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.messaginghostednumbers.MessagingHostedNumberRetrieveParams;

            import
            com.telnyx.sdk.models.messaginghostednumbers.MessagingHostedNumberRetrieveResponse;
        ...
        - lang: Ruby
          source: >-
            ...
            telnyx.messaging_hosted_numbers.retrieve("id")
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $messagingHostedNumber = $client->messagingHostedNumbers->retrieve('id');
        ...
        - lang: CLI
          source: |-
            telnyx messaging-hosted-numbers retrieve \
              --api-key 'My API Key' \
              --id id
components:
  schemas:
