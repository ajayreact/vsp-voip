...
source_url: "https://developers.telnyx.com/api-reference/credential-connections/update-a-credential-connection.md"
category: "sip"
synced_at: "2026-06-25T18:43:24.148Z"
content_hash: "d3d64c58c02fca797a58ef1753befbd8af6e5594bd2ee35dcf94867cbb0e6806"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/real-time-communications/sip-connections.yml patch /credential_connections/{id}
openapi: 3.1.0
info:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.credentialConnections.update('id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.credentialconnections.CredentialConnectionUpdateResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $credentialConnection = $client->credentialConnections->update(
                'id',
                active: true,
        ...
        - lang: CLI
          source: |-
            telnyx credential-connections update \
              --api-key 'My API Key' \
              --id id
components:
  schemas:
