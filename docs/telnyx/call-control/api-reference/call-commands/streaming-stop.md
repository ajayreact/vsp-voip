...
source_url: "https://developers.telnyx.com/api-reference/call-commands/streaming-stop.md"
category: "call-control"
synced_at: "2026-06-25T18:43:15.280Z"
content_hash: "58007a7e115f761da6b607fbcefbbac7c64fad90e3c5a3f3ae23d79864b7110c"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/streaming-stop.yml post /calls/{call_control_id}/actions/streaming_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - Streaming Stop
  version: 2.0.0
  description: API for stopping call streaming.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopStreaming('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionStopStreamingParams;

            import
            com.telnyx.sdk.models.calls.actions.ActionStopStreamingResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopStreaming(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-streaming \
              --api-key 'My API Key' \
    ...
    StopStreamingRequest:
      ...
      properties:
        ...
        stream_id:
          ...
          description: >-
            Identifies the stream. If the `stream_id` is not provided the
