---
title: "Enqueue call"
source_url: "https://developers.telnyx.com/api-reference/call-commands/enqueue-call.md"
category: "call-control"
synced_at: "2026-06-25T18:43:09.647Z"
content_hash: "f546703184ef959add8f5a647c389e1db8f225bfa8fcc85caf62bfd7ef49c6f5"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/enqueue.yml post /calls/{call_control_id}/actions/enqueue
openapi: 3.1.0
info:
  title: Telnyx Call Control - Enqueue
  version: 2.0.0
  description: API for enqueueing a call.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.enqueue('call_control_id', { queue_name:
            'support' });
        ...
        - lang: Ruby
          source: >-
            ...
            response = telnyx.calls.actions.enqueue("call_control_id",
            queue_name: "support")
  ...
  schemas:
    EnqueueRequest:
      ...
      properties:
        queue_name:
          description: >-
            The name of the queue the call should be put in. If a queue with a
        ...
        keep_after_hangup:
          type: boolean
          description: >-
            If set to true, the call will remain in the queue after hangup. In
            this case bridging to such call will fail with necessary information
