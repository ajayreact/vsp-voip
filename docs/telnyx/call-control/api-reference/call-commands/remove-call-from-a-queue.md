...
source_url: "https://developers.telnyx.com/api-reference/call-commands/remove-call-from-a-queue.md"
category: "call-control"
synced_at: "2026-06-25T18:43:12.040Z"
content_hash: "b19c7506cb1a809afcab277e4abb140e1a4ecf5b3c983d3200fef95b2c1075cd"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/leave-queue.yml post /calls/{call_control_id}/actions/leave_queue
openapi: 3.1.0
info:
  title: Telnyx Call Control - Leave Queue
  version: 2.0.0
  description: API for leaving a queue.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.leaveQueue('call_control_id');
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->leaveQueue(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions leave-queue \
              --api-key 'My API Key' \
