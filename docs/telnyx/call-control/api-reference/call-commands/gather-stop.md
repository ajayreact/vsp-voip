---
title: "Gather stop"
source_url: "https://developers.telnyx.com/api-reference/call-commands/gather-stop.md"
category: "call-control"
synced_at: "2026-06-25T18:43:10.589Z"
content_hash: "f1287770e060a63de0435dbc3cb7124fe5294034a3c38b6b6e7cf87d0f6ae3dc"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/gather-stop.yml post /calls/{call_control_id}/actions/gather_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - Gather Stop
  version: 2.0.0
  description: API for stopping gather.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopGather('call_control_id');
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopGather(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-gather \
              --api-key 'My API Key' \
