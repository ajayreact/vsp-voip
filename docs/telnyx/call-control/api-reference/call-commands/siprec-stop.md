---
title: "SIPREC stop"
source_url: "https://developers.telnyx.com/api-reference/call-commands/siprec-stop.md"
category: "sip"
synced_at: "2026-06-25T18:43:14.569Z"
content_hash: "e8d6d38854cf7d32c7876d064b4bc0cf027a5bc351ccab81766da176c0a9511f"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/siprec-stop.yml post /calls/{call_control_id}/actions/siprec_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - SIPREC Stop
  version: 2.0.0
  description: API for stopping SIPREC.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopSiprec('call_control_id');
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopSiprec(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-siprec \
              --api-key 'My API Key' \
