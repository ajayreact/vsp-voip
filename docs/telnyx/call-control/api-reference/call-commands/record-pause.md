---
title: "Record pause"
source_url: "https://developers.telnyx.com/api-reference/call-commands/record-pause.md"
category: "call-control"
synced_at: "2026-06-25T18:43:13.494Z"
content_hash: "272724548e50883ca16265544225a6125c30077a98eb674fd5e23e4dad19a8f0"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/record-pause.yml post /calls/{call_control_id}/actions/record_pause
openapi: 3.1.0
info:
  title: Telnyx Call Control - Record Pause
  version: 2.0.0
  description: API for pausing call recording.
  contact:
...
paths:
  /calls/{call_control_id}/actions/record_pause:
    post:
      ...
      description: >
        Pause recording the call. Recording can be resumed via Resume recording
        command.
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.pauseRecording('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionPauseRecordingParams;

            import
            com.telnyx.sdk.models.calls.actions.ActionPauseRecordingResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->pauseRecording(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions pause-recording \
              --api-key 'My API Key' \
