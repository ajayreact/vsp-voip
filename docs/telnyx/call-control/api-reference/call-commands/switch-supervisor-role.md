...
source_url: "https://developers.telnyx.com/api-reference/call-commands/switch-supervisor-role.md"
category: "call-control"
synced_at: "2026-06-25T18:43:15.522Z"
content_hash: "54a837a4cf5c6df5dcceed59f03b527840633eb6cf171094ca01c919025ad186"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/switch-supervisor-role.yml post /calls/{call_control_id}/actions/switch_supervisor_role
openapi: 3.1.0
info:
  title: Telnyx Call Control - Switch Supervisor Role
  version: 2.0.0
  description: API for switching supervisor role.
  contact:
...
paths:
  /calls/{call_control_id}/actions/switch_supervisor_role:
    post:
      ...
      description: >-
        Switch the supervisor role for a bridged call. This allows switching
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.switchSupervisorRole('call_control_id', {
              role: 'barge',
            });
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionSwitchSupervisorRoleParams;

            import
            com.telnyx.sdk.models.calls.actions.ActionSwitchSupervisorRoleResponse;
        ...
        - lang: Ruby
          source: >-
            ...
            response =
            telnyx.calls.actions.switch_supervisor_role("call_control_id", role:
            :barge)
  ...
  schemas:
    SwitchSupervisorRoleRequest:
      ...
      properties:
        role:
          description: >-
            The supervisor role to switch to. 'barge' allows speaking to both
            parties, 'whisper' allows speaking to caller only, 'monitor' allows
            listening only.
          type: string
          enum:
            - barge
