---
title: "Forking stop"
source_url: "https://developers.telnyx.com/api-reference/call-commands/forking-stop.md"
category: "call-control"
synced_at: "2026-06-25T18:43:10.126Z"
content_hash: "fa1a20209f8a2d2d9c780140f2423fce877bbc20ab78629e78991e836b7d45d6"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/fork-stop.yml post /calls/{call_control_id}/actions/fork_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - Fork Stop
  version: 2.0.0
  description: API for stopping call forking.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopForking('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionStopForkingResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopForking(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-forking \
              --api-key 'My API Key' \
  ...
  schemas:
    StopForkingRequest:
      ...
      properties:
        ...
        stream_type:
          description: >-
            Optionally specify a `stream_type`. This should match the
            `stream_type` that was used in `fork_start` command to properly stop
            the fork.
          type: string
          enum:
            - raw
