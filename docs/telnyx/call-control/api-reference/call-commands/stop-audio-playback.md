...
source_url: "https://developers.telnyx.com/api-reference/call-commands/stop-audio-playback.md"
category: "call-control"
synced_at: "2026-06-25T18:43:12.532Z"
content_hash: "c9d562a6220f0666b9934072a5fe95582f1eeb39326af91e8669b8477c6a20d0"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/playback-stop.yml post /calls/{call_control_id}/actions/playback_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - Playback Stop
  version: 2.0.0
  description: API for stopping audio playback.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopPlayback('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionStopPlaybackResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopPlayback(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-playback \
              --api-key 'My API Key' \
  ...
  schemas:
    PlaybackStopRequest:
      ...
      properties:
        ...
        stop:
          description: >-
            Use `current` to stop the current audio being played. Use `all` to
            stop the current audio file being played and clear all audio files
            from the queue.
          type: string
          example: current
          default: all
