---
title: "Forking start"
source_url: "https://developers.telnyx.com/api-reference/call-commands/forking-start.md"
category: "call-control"
synced_at: "2026-06-25T18:43:09.891Z"
content_hash: "e37198412595bd14d7be77475b079aa85e9c793604a28660a29eb98913baa4dc"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/fork-start.yml post /calls/{call_control_id}/actions/fork_start
openapi: 3.1.0
info:
  title: Telnyx Call Control - Fork Start
  version: 2.0.0
  description: API for starting call forking.
  contact:
...
paths:
  /calls/{call_control_id}/actions/fork_start:
    post:
      ...
      description: >+
        Call forking allows you to stream the media from a call to a specific
        target in realtime. 
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.startForking('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionStartForkingResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->startForking(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions start-forking \
              --api-key 'My API Key' \
  ...
  schemas:
    StartForkingRequest:
      ...
      properties:
        ...
        stream_type:
          description: >-
            Optionally specify a media type to stream. If `decrypted` selected,
            Telnyx will decrypt incoming SIP media before forking to the target.
