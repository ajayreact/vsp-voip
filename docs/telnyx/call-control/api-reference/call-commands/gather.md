---
title: "Gather"
source_url: "https://developers.telnyx.com/api-reference/call-commands/gather.md"
category: "call-control"
synced_at: "2026-06-25T18:43:10.359Z"
content_hash: "b98cb5eeff5ced6c983ac68f27b16f7ee144222a03dfd34b7154c6cdeef09f81"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/gather.yml post /calls/{call_control_id}/actions/gather
openapi: 3.1.0
info:
  title: Telnyx Call Control - Gather
  version: 2.0.0
  description: API for gathering DTMF input.
  contact:
  ...
  /calls/{call_control_id}/actions/gather:
    post:
      ...
      description: >
        ...
        You can pass a list of valid digits. The `Answer` command must be issued
        before the `gather` command.
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.gather('call_control_id');
  ...
  schemas:
    GatherRequest:
      ...
      properties:
        ...
        gather_id:
          description: >-
            An id that will be sent back in the corresponding
            `call.gather.ended` webhook. Will be randomly generated if not
            specified.
          type: string
