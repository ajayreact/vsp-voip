...
source_url: "https://developers.telnyx.com/api-reference/call-commands/recording-stop.md"
category: "recordings"
synced_at: "2026-06-25T18:43:13.051Z"
content_hash: "bdd9ff5e4ba0c9f767b33e034b36d0f544f01d3cc652a6328e0b2da75a836068"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/record-stop.yml post /calls/{call_control_id}/actions/record_stop
openapi: 3.1.0
info:
  title: Telnyx Call Control - Record Stop
  version: 2.0.0
  description: API for stopping call recording.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.stopRecording('call_control_id');
        ...
        - lang: Java
          source: >-
            ...
            import
            com.telnyx.sdk.models.calls.actions.ActionStopRecordingParams;

            import
            com.telnyx.sdk.models.calls.actions.ActionStopRecordingResponse;
        ...
        - lang: PHP
          source: >-
            ...
            try {
              $response = $client->calls->actions->stopRecording(
                'call_control_id',
        ...
        - lang: CLI
          source: |-
            telnyx calls:actions stop-recording \
              --api-key 'My API Key' \
