---
title: "Reject a call"
source_url: "https://developers.telnyx.com/api-reference/call-commands/reject-a-call.md"
category: "call-control"
synced_at: "2026-06-25T18:43:11.819Z"
content_hash: "de82bc322153808b7acf262cac972dc4c5e1b6a1eb553380469d9d72256079db"
---
> ## Documentation Index
...
````yaml https://telnyx-openapi-ng.s3.us-east-1.amazonaws.com/call-control-commands/reject.yml post /calls/{call_control_id}/actions/reject
openapi: 3.1.0
info:
  title: Telnyx Call Control - Reject
  version: 2.0.0
  description: API for rejecting a call.
  contact:
      ...
      x-codeSamples:
        - lang: JavaScript
          source: >-
            ...
            client.calls.actions.reject('call_control_id', { cause: 'USER_BUSY'
            });
        ...
        - lang: Ruby
          source: >-
            ...
            response = telnyx.calls.actions.reject("call_control_id", cause:
            :USER_BUSY)
