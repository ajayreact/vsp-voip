...
/**
 * Ring-first (Telnyx Find Me pattern): defer PSTN answer for direct desk / hunt-group SIP rings.
 * Parked inbound → dial agent → bridge on agent call.answered (no early PSTN answer).
 * @see docs/telnyx/call-control/guides/ivr-demo.md — Find Me / Follow Me IVR
 */
function shouldDeferPstnAnswerUntilDesk({
  ...
  if (!targets.every((target) => target.type === 'sip')) return false;
