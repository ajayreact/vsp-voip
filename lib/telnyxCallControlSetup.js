...
/** Dedicated V3 Call Control Application for desk parked outbound (does not replace legacy app). */
function getV3CallControlApplicationId() {
  return process.env.TELNYX_V3_CALL_CONTROL_APP_ID?.trim() || null;
}
