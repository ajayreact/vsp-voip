...
async function handleInternalExtensionCallInitiated(prisma, payload, platform, targetExtensionNumber) {
  ...
  console.log('TRACE handleInternalExtensionCallInitiated: entry — legacy/app extension router (Extension -> Extension scenario)', {
    extensionRequested: targetExtensionNumber,
    callControlId,
