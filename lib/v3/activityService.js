...
const ACTION_META = {
  ...
  'v3.backup.created': { category: 'backup', label: 'Backup Created' },
  'v3.backup.restored': { category: 'backup', label: 'Backup Restored' },
  'v3.export.completed': { category: 'export', label: 'Configuration Exported' },
  'v3.import.validated': { category: 'import', label: 'Import Validated' },
  'v3.import.applied': { category: 'import', label: 'Import Applied' },
  'v3.subscription.changed': { category: 'subscription', label: 'Subscription Changed' },
  'v3.lifecycle.archived': { category: 'lifecycle', label: 'Tenant Archived' },
  'v3.lifecycle.deactivated': { category: 'lifecycle', label: 'Tenant Deactivated' },
  'v3.lifecycle.reactivated': { category: 'lifecycle', label: 'Tenant Reactivated' },
  'v3.runtime.sync.enqueued': { category: 'runtime', label: 'Runtime Sync Enqueued' },
  'v3.runtime.sync.completed': { category: 'runtime', label: 'Runtime Sync Completed' },
  'v3.runtime.sync.failed': { category: 'runtime', label: 'Runtime Sync Failed' },
  'v3.runtime.sync.retried': { category: 'runtime', label: 'Runtime Sync Retried' },
  'v3.runtime.sync.dead_letter': { category: 'runtime', label: 'Runtime Sync Dead Letter' },
  'v3.runtime.repair.completed': { category: 'runtime', label: 'Runtime Repair Completed' },
  'v3.callflow.published': { category: 'callflow', label: 'Call Flow Published' },
  'v3.validation.completed': { category: 'production', label: 'Runtime Validation Completed' },
  'v3.migration.preview': { category: 'migration', label: 'Migration Preview' },
  'v3.migration.validated': { category: 'migration', label: 'Migration Validated' },
  'v3.migration.executed': { category: 'migration', label: 'Migration Executed' },
  'v3.migration.rollback.preview': { category: 'migration', label: 'Migration Rollback Preview' },
  'v3.migration.rollback.executed': { category: 'migration', label: 'Migration Rollback Executed' },
  'v3.rollback.preview': { category: 'rollback', label: 'Rollback Preview' },
  'v3.rollback.executed': { category: 'rollback', label: 'Rollback Executed' },
  'v3.production.health.checked': { category: 'production', label: 'Production Health Checked' },
  'v3.testlab.tenant_created': { category: 'testlab', label: 'Test Lab Tenant Created' },
  'v3.testlab.number_assigned': { category: 'testlab', label: 'Test Lab Number Assigned' },
  'v3.testlab.teardown': { category: 'testlab', label: 'Test Lab Teardown' },
  'v3.testlab.completed': { category: 'testlab', label: 'Test Lab Run Completed' },
};
