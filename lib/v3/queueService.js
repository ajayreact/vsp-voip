...
async function createQueue(prisma, tenantId, data, { req, actor } = {}) {
  ...
  await enqueueRuntimeSync(prisma, tenantId, 'queue', row.id, 'sync', { req });
...
async function updateQueue(prisma, tenantId, id, data, { req, actor } = {}) {
  ...
  await enqueueRuntimeSync(prisma, tenantId, 'queue', id, 'sync', { req });
...
async function removeQueue(prisma, tenantId, id, { req, actor } = {}) {
  ...
  await enqueueRuntimeSync(prisma, tenantId, 'queue', id, 'delete', { req });
