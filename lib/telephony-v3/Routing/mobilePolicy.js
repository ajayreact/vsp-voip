...
const { POLICY_ACTION } = require('./mobileRouteResult');

/**
 * Evaluate mobile routing policy (Phase 3.3 — enforcement when observeOnly=false).
 *
 * @param {{
 *   tenant: object,
 ...
 * }} input
 */
async function evaluateMobilePolicy(input) {
  ...
  if (input.routingFlow === 'MOBILE_TO_PSTN') {
