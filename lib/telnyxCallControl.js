...
async function dialDestination(callControlId, {
  ...
  console.log('[DESK OUTBOUND TRACE]', 'STEP 7 Calling dialDestination()', {
  ...
  console.log('[DESK OUTBOUND TRACE]', 'STEP 8 dialDestination() returned', {
    callControlId: callControlId || null,
    destination: to || null,
    outboundLegId: result?.call_control_id ?? result?.data?.call_control_id ?? null,
  });
