...
} from '../../mobile-rn/src/messaging/format';
import type { PlatformMessage } from '../../mobile-rn/src/messaging/types';

describe('mobile messaging format', () => {
  ...
  it('filters conversations by peer, line, and preview', () => {
    const items = [
      { id: '1', peer: '+13095551212', line: '+15551234567', lastMessagePreview: 'Hello', unreadCount: 0 },
      { id: '2', peer: '+15559876543', line: '+15551234567', lastMessagePreview: 'Invoice', unreadCount: 0 },
    ];
  ...
  it('sorts conversations by latest activity', () => {
    const sorted = sortConversationsByActivity([
      { id: 'a', peer: '+1', line: '+1', unreadCount: 0, lastMessageAt: '2026-01-01T00:00:00.000Z' },
      { id: 'b', peer: '+1', line: '+1', unreadCount: 0, lastMessageAt: '2026-06-01T00:00:00.000Z' },
    ]);
  ...
  it('formats date separators', () => {
    const today = formatDateSeparator(new Date().toISOString());
