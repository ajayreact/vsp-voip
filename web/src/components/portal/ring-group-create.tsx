...
import { RING_STRATEGIES } from '@/lib/ring-group-utils';

export function RingGroupCreatePage() {
  ...
  return (
    <div className="space-y-6">
      <PortalPageHeader
        ...
        description="Configure ringing strategy and group settings. Add members after creation."
        actions={
      ...
      <form onSubmit={onSubmit} className="panel-card max-w-2xl space-y-5 p-6">
        <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="200"
          />
          <p className="mt-1 text-xs text-slate-500">Internal extension number for this group</p>
        </div>
