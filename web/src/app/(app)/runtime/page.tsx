  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 text-sm">
        <Link href="/runtime/jobs" className="font-medium text-slate-700 underline hover:text-slate-900">View sync jobs</Link>
        <Link href="/runtime/health" className="font-medium text-slate-700 underline hover:text-slate-900">Detailed health</Link>
      </div>
    </div>
  );
}
