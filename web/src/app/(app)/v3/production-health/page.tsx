...
export default function V3ProductionHealthPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 text-sm">
        <QuickLink href="/v3/monitoring" label="Monitoring" />
        <QuickLink href="/v3/diagnostics" label="Diagnostics" />
        <QuickLink href="/v3/runtime-validation" label="Runtime Validation" />
        <QuickLink href="/v3/migration" label="Migration" />
      </div>
    </div>
  );
}
