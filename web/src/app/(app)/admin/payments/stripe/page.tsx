...
export default function AdminStripePaymentsPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400">Stripe card checkout and webhooks for tenant orders.</p>
      </div>

      <AdminPaymentsNav />
      <AdminPlatformSettingsForm sections={['stripe']} saveLabel="Save Stripe settings" />
    </div>
  );
}
